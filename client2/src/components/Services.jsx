      ...
      <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services '>
        <div className='flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4'>
              <div className='flex-1 flex flex-col justify-start items-start'>
                    <h1 className='text-white text-3xl sm:text-5xl py-2 text-gradient'>Servies that we
        ...
        <div className='flex-1 flex flex-col justify-start items-center pt-20'>
              <ServiceCard
                  ...
                  subtitle='Security is guranteed. We always maintain privacy and maintain quality of out product'
              />
